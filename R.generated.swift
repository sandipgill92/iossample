...
struct R: Rswift.Validatable {
  ...
  struct file {
    /// Resource file `wallpaperflare.jpg`.
    static let wallpaperflareJpg = Rswift.FileResource(bundle: R.hostingBundle, name: "wallpaperflare", pathExtension: "jpg")

    /// `bundle.url(forResource: "wallpaperflare", withExtension: "jpg")`
    static func wallpaperflareJpg(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.wallpaperflareJpg
  ...
  struct image {
    ...
    static let wallpaperflareJpg = Rswift.ImageResource(bundle: R.hostingBundle, name: "wallpaperflare.jpg")

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "wallpaperflare.jpg", bundle: ..., traitCollection: ...)`
    static func wallpaperflareJpg(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.wallpaperflareJpg, compatibleWith: traitCollection)
    }
    #endif
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct main: Rswift.StoryboardResourceType, Rswift.Validatable {
      ...
      static func validate() throws {
        ...
        if _R.storyboard.main().loginView() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'loginView' could not be loaded from storyboard 'Main' as 'LoginView'.") }
